...
This module is used to write sleektiv form select widgets
"""
...
class SleektivMultiSelectWidget(forms.Widget):
    """
    ...
    template_name = "sleektiv_widgets/sleektiv_multiselect_widget.html"
