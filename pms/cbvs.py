...
class BonusPointSettingSectionView(views.SleektivSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.SleektivNavView):
    """
...
class BonusPointSettingFormView(views.SleektivFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.SleektivListView):
    """
...
class EmployeeBonusPointSectionView(views.SleektivSectionView):
    """
...
class EmployeeBonusPointNavView(views.SleektivNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.SleektivFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.SleektivListView):
    """
    BnusPoint list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackEmployeeFormView(views.SleektivFormView):
    """
...
class BulkFeedbackFormView(views.SleektivFormView):
    """
    Feedback other employee form View
    """
