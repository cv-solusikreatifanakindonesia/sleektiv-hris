...
from sleektiv.sleektiv_settings import DYNAMIC_URL_PATTERNS, SLEEKTIV_DATE_FORMATS
from sleektiv.methods import remove_dynamic_url
...
def work_record_export(request):
    ...
    format_string = SLEEKTIV_DATE_FORMATS.get(date_format)
