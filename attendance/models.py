...
class AttendanceActivity(SleektivModel):
    """
...
class BatchAttendance(SleektivModel):
    """
...
class Attendance(SleektivModel):
    """
    Attendance model
    """
...
class AttendanceRequestFile(SleektivModel):
    file = models.FileField(upload_to="attendance/request_files")


class AttendanceRequestComment(SleektivModel):
    """
...
class AttendanceOverTime(SleektivModel):
    """
...
class AttendanceLateComeEarlyOut(SleektivModel):
    """
...
class AttendanceValidationCondition(SleektivModel):
    """
...
class AttendanceGeneralSetting(SleektivModel):
    """
