"""
sleektiv_api/urls/attendance/urls.py
"""

from django.urls import path

from sleektiv_api.api_views.attendance.permission_views import AttendancePermissionCheck
from sleektiv_api.api_views.attendance.views import *
