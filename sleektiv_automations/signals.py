"""
sleektiv_automation/signals.py
...
from sleektiv.signals import post_bulk_update, pre_bulk_update
...
def send_automated_mail(
    ...
    from sleektiv_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from sleektiv_automations.methods.methods import (
        get_model_class,
