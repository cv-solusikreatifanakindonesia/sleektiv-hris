"""
sleektiv_automations/views/cbvs.py
"""
...
from sleektiv_automations.forms import AutomationForm
...
class AutomationSectionView(views.SleektivSectionView):
    ...
    template_name = "sleektiv_automations/section_view.html"
...
class AutomationNavView(views.SleektivNavView):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.actions = []
        if self.request.user.has_perm("sleektiv_automation.add_mailautomation"):
            self.create_attrs = f"""
...
class AutomationFormView(views.SleektivFormView):
    ...
    template_name = "sleektiv_automations/automation_form.html"
...
@method_decorator(login_required, name="dispatch")
@method_decorator(
    permission_required("sleektiv_automation.add_mailautomation"), name="dispatch"
)
class LoadAutomationsView(View):
    template_name = "sleektiv_automations/load_automation.html"
