...
class Employee(models.Model):
    ...
    def get_archive_condition(self):
        ...
        if apps.is_installed("onboarding"):
            OnboardingStage = get_sleektiv_model_class("onboarding", "onboardingstage")
            OnboardingTask = get_sleektiv_model_class("onboarding", "onboardingtask")
        ...
        if apps.is_installed("recruitment"):
            Recruitment = get_sleektiv_model_class("recruitment", "recruitment")
            Stage = get_sleektiv_model_class("recruitment", "stage")
    ...
    def check_online(self):
        ...
        """
        if apps.is_installed("attendance"):
            Attendance = get_sleektiv_model_class("attendance", "attendance")
