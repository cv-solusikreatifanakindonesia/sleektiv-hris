"""
sleektiv_views/urls.py
"""

from django.urls import path

from sleektiv_views import views
from sleektiv_views.generic.cbv import history
from sleektiv_views.generic.cbv.views import ReloadMessages
