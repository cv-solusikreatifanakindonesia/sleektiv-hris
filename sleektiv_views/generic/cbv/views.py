...
from sleektiv.filters import FilterSet
...
from sleektiv_views.cbv_methods import (  # update_initial_cache,
    export_xlsx,
    get_short_uuid,
    hx_request_required,
    paginator_qry,
...
from sleektiv_views.forms import DynamicBulkUpdateForm, ToggleColumnForm
...
class SleektivListView(ListView):
    ...
    template_name: str = "generic/sleektiv_list_table.html"
...
class SleektivSectionView(TemplateView):
    ...
    template_name = "generic/sleektiv_section.html"
...
class SleektivTabView(TemplateView):
    ...
    template_name = "generic/sleektiv_tabs.html"
...
class SleektivCardView(ListView):
    ...
    template_name = "generic/sleektiv_card.html"
    context_object_name = "queryset"
...
class SleektivFormView(FormView):
    ...
    template_name = "generic/sleektiv_form.html"
    ids_key: str = "instance_ids"
...
class SleektivNavView(TemplateView):
    ...
    template_name = "generic/sleektiv_nav.html"
