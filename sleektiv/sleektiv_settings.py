...
from sleektiv.sleektiv_apps import INSTALLED_APPS
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": settings.env("BIND_DN", default="cn=admin,dc=sleektiv,dc=com"),
    "BIND_PASSWORD": settings.env("BIND_PASSWORD", default="sleektiv"),
    "BASE_DN": settings.env("BASE_DN", default="ou=users,dc=sleektiv,dc=com"),
}
...
def load_ldap_settings():
    ...
    try:
        ...
        from sleektiv_ldap.models import LDAPSettings
