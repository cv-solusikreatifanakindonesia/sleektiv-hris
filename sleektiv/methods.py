...
from sleektiv.sleektiv_settings import APP_URLS, DYNAMIC_URL_PATTERNS


def get_sleektiv_model_class(app_label, model):
    """
...
def sleektiv_users_with_perms(permissions):
    """
