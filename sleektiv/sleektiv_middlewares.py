"""
sleektiv_middlewares.py

This module is used to register sleektiv's middlewares without affecting the sleektiv/settings.py
"""
...
MIDDLEWARE.append("sleektiv.sleektiv_middlewares.MethodNotAllowedMiddleware")
MIDDLEWARE.append("sleektiv.sleektiv_middlewares.ThreadLocalMiddleware")
