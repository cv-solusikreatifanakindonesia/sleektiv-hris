"""
sleektiv_context_process.py

This module is used to register context processors without effecting the sleektiv/settings.py module
"""

from sleektiv.settings import TEMPLATES

TEMPLATES[0]["OPTIONS"]["context_processors"].append(
    "sleektiv.config.get_MENUS",
)
TEMPLATES[0]["OPTIONS"]["context_processors"].append(
